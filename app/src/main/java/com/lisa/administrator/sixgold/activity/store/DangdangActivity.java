...
public class DangdangActivity extends MyBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dangdang);
        initActionBarTwoImg(R.drawable.ic_chevron_left_grey_24dp, "当当", -1, null);
    ...
    private void initBrowser() {
        //WebView
        browser = (WebView) findViewById(R.id.wv_dangdang);
