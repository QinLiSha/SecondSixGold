...
public class GuomeiActivity extends MyBaseActivity {
...
//    String TestUrl = "http://www.suning.com/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guomei);
        initActionBarTwoImg(R.drawable.ic_chevron_left_grey_24dp, "国美在线", -1, null);
        initBrowser();
        initBack();
    }
    ...
    private void initBrowser() {
        //WebView
        browser = (WebView) findViewById(R.id.wv_guomei);
        ...
        //设置可自由缩放网页
        settings.setDomStorageEnabled(true);//可能不行
//        settings.setAllowContentAccess(true);//可能不行
//        settings.setBlockNetworkLoads(true);//可能不行
