...
/**
 * Created by One Of A Kind Lisa适配器
 * 同城货运
 */

public class CarTypeListViewLocalAdapter extends MyBaseAdapter {

    public CarTypeListViewLocalAdapter(Context context) {
        super(context);
    }
...
//        convertView.setTag(vh);
        ...
        //获得组件，实例化组件
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.layout_listview_item_local_distance, null);
            vh = new ViewHolder();
            vh.iv_car_people_img = (ImageView) convertView.findViewById(R.id.iv_car_local_people_img);
            vh.tv_distance = (TextView) convertView.findViewById(R.id.tv_car_local_distance);
            vh.tv_cartype = (TextView) convertView.findViewById(R.id.tv_car_local_cartype);
            vh.tv_can_weight = (TextView) convertView.findViewById(R.id.tv_car_local_can_weight);
            vh.tv_delivery_times = (TextView) convertView.findViewById(R.id.tv_car_local_delivery_times);
            vh.tv_name = (TextView) convertView.findViewById(R.id.tv_car_local_name);
            vh.tv_rate_of_praise = (TextView) convertView.findViewById(R.id.tv_car_local_rate_of_praise);
            convertView.setTag(vh);
        } else {
            vh = (ViewHolder) convertView.getTag();
        }
        vh.iv_car_people_img.setBackgroundResource(R.mipmap.mianbao);
        vh.tv_distance.setText(300 + "米");
        vh.tv_cartype.setText("面包车");
        vh.tv_can_weight.setText(1.5 + "吨");
        vh.tv_delivery_times.setText(2045 + "");
        vh.tv_name.setText("刘师傅");
        vh.tv_rate_of_praise.setText(96 + "%");
