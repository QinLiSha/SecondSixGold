...
public class MogujieActivity extends MyBaseActivity {
    private WebView browser;
    WebSettings settings;
    String TestUrl = "http://www.mogujie.com/";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mogujie);
        initActionBarTwoImg(R.drawable.ic_chevron_left_grey_24dp, "蘑菇街", -1, null);
    ...
    private void initBrowser() {
        //WebView
        browser = (WebView) findViewById(R.id.wv_mogujie);
