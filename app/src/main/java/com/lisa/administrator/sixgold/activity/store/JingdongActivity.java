...
public class JingdongActivity extends MyBaseActivity {
    private WebView browser;
    WebSettings settings;
    String TestUrl = "https://www.jd.com/";//

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jingdong);
        initActionBarTwoImg(R.drawable.ic_chevron_left_grey_24dp, "京东", -1, null);
    ...
    private void initBrowser() {
        //WebView
        browser = (WebView) findViewById(R.id.wv_jingdong);
